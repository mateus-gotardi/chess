...
describe("tests with empty table", () => {
  ...
  it("should add a king in the middle of the table and check his moves", () => {
    TABLE.setPiece(4, 3, new ChessPiece({ name: ChessPieceName.KING, color: ChessPieceColor.WHITE, isAttacked: false, isMoved: true }))
  ...
  it('should not allow a king to get close to another king', () => {
    TABLE.setPiece(4, 5, new ChessPiece({ name: ChessPieceName.KING, color: ChessPieceColor.BLACK, isAttacked: false, isMoved: true }))
  ...
  it('should remove previous test pieces', () => {
    TABLE.setPiece(4, 3, new ChessPiece({ name: ChessPieceName.EMPTY, color: ChessPieceColor.NULL, isAttacked: false, isMoved: false }))
    TABLE.setPiece(4, 5, new ChessPiece({ name: ChessPieceName.EMPTY, color: ChessPieceColor.NULL, isAttacked: false, isMoved: false }))
  ...
  it('should place white king and rooks', () => {
    TABLE.setPiece(0, 4, new ChessPiece({ name: ChessPieceName.KING, color: ChessPieceColor.WHITE, isAttacked: false, isMoved: false }))
    TABLE.setPiece(0, 0, new ChessPiece({ name: ChessPieceName.ROOK, color: ChessPieceColor.WHITE, isAttacked: false, isMoved: false }))
    TABLE.setPiece(0, 7, new ChessPiece({ name: ChessPieceName.ROOK, color: ChessPieceColor.WHITE, isAttacked: false, isMoved: false }))
  ...
  it('should place black king and rooks', () => {
    TABLE.setPiece(7, 4, new ChessPiece({ name: ChessPieceName.KING, color: ChessPieceColor.BLACK, isAttacked: false, isMoved: false }))
    TABLE.setPiece(7, 0, new ChessPiece({ name: ChessPieceName.ROOK, color: ChessPieceColor.BLACK, isAttacked: false, isMoved: false }))
    TABLE.setPiece(7, 7, new ChessPiece({ name: ChessPieceName.ROOK, color: ChessPieceColor.BLACK, isAttacked: false, isMoved: false }))
  ...
  it('should test black castling move', () => {
    ...
    expect(TABLE.getTurn()).toBe(ChessPieceColor.BLACK)
    TABLE.movePiece(7, 4, 7, 6)
    expect(TABLE.getTurn()).toBe(ChessPieceColor.WHITE)
    expect(TABLE.getPiece(7, 6).name).toBe(ChessPieceName.KING)
    expect(TABLE.getPiece(7, 6).color).toBe(ChessPieceColor.BLACK)
    expect(TABLE.getPiece(7, 4).name).toBe(ChessPieceName.EMPTY)
    expect(TABLE.getPiece(7, 5).name).toBe(ChessPieceName.ROOK)
    expect(TABLE.getPiece(7, 5).color).toBe(ChessPieceColor.BLACK)
  })
});
